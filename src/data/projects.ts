...
export const projects: Project[] = [
  {
    id: 'mbm-rds-clone',
    title: 'MBM Production Data + AI Platform',
  ...
  },
  {
    ...
    subtitle: 'Shop-Floor Time Tracking — MBM Client Work',
    description:
      'Every task at MBM\'s lab workstations gets its own QR sticker — workers scan it, tap their name, and clock in or out. Task-level time data lands in Postgres and feeds the same production data platform as the rest of MBM\'s systems. In daily use on the floor.',
  ...
  },
  {
    ...
    description:
      'Pulls from three APIs in parallel, queries Postgres, analyzes a year of campaign performance data, and auto-generates optimized monthly marketing schedules. Built at BS&Co and running in production daily.',
  ...
  },
  {
    ...
    subtitle: 'Headless E-Commerce Storefront',
    description:
